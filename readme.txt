...
2021-11-18 (test-only) Перед установкой обновления не забудьте сделать backup. Настройки будут сброшены
...
2021-11-20 (test-only)	Требуется обновление RESDUMP.bin
...
2021-11-24 (test only)
	-printing help_id=3 Виджет предварительного просмотра, Виджет печати, Инструменты времени печати, Подстройки печати
