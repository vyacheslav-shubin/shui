...
2021-10-08 (test-only) Обязательно обновить сниппеты!!!
	...
	-Обмер стола. Можно задать до 5 обмеров одной точки.
		-поддерживается 2 алгоритма работы.
			1. Все измерения проводятся, значение усредняется
			2. Проводится не более максимального значения измерений. В случае наличия в серии двух измерений
