...
2022-09-02 (test only) требуется обновить RESDUMP.BIN
	...
	-Исправлена ошибка отображения времени печати файла в виджете предварительноо просмотра
	-Экспериментальный режим. Этап 1. При уходе на паузу создается файл SHUI/RECOVER.GCO по которому можно восстановить печать после полного отключения питания.
		файл содержит:
			Сохраненные по G60 координаты, текущие координаты, состояние вентилятора и нагрвателей, смещение координатных осей
	...
	-Информационная строка в вижете печати: текущая строка файла g кода
	...
	Срабатывание сниппетов 21 и 20 обрабатыватеся защитой от дребезга. Сниппет 27 срабатывает незамедлительно.
