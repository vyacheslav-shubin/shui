...
2025-07-13 (test_only), требуется обновление RESDUMP.BIN
	-📍PA8 можно использовать для управлеия лазером на всех платах
	-📍Пресеты скорости перемещения. Алгоритм работает только для конфигурации Лазер или Гравер. Включается в разделе конфигурации "G код".
		...
		Таблица замены может быть отредактирована непосредсвенно перед запуском файла управляющей программы, или определена заранее в конфигурации (раздел конфигурации "G код")
