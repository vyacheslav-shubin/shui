...
2025-06-01 (test_only), требуется обновление RESDUMP.BIN
	-📍Испрален алгортм отката после парковки, если для концевых датчиков указано отлицательное смещение
	...
	-📍Пролистываение в браузере файлов теперь циклическое. После последней страницы переход на первую и наоборот. Долгое нажатие на кнопки перелистывания страниц выполняет соответсвующий переход либо к первой странице, либо к последней.
