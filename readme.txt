...
2023-08-07 (test only)	
	...
	-Добавлен алгоритм полигональной интерполяции выравниванпя стола
	-Билинейный алгоритм может рабоать по 9 и 4 точкам
	-Полигональный алгоритм может работать по 5 и 13 точкам
	-Тип замера стола может быть изменен перед печатью
	-В настройки добавлена позможность изменить высоту затуханий и размер сегмента алгоритма выравнивания, 13 точек сетки 
	...
	-M421 добавлен параметр S (сохнанение сетки в eeprom)
	-Добавлен алоритм компенсации люфтов ( @Romushock, вашей обещанной части так и не появилось, впрочем, ожидаемо)
