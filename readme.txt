...
2021-11-30 (test-only) ВНИМАНИЕ @snippets.gcode обновлен! Если ранее использовались сниппеты ПРИМЕНЕНИЕ @snippets.gcode или сброс сниппетов после прошивки ОБЯЗАТЕЛЬНО!
	Омедвеживание:
...
2021-12-02 (dev) 
	M2021 - калибровка PID по таблице 
		S - слот (0-4) если слот не указан, замеры производятся для всех слотов
