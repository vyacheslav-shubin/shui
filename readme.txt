...
2023-02-17 (test only) Обновлен RESDUMP.BIN
...
2023-04-15 (test only) обновлен RESDUMP.BIN
		-Исправлена отрисовка виджета выбора WiFi сети.
		-Виджет прогресса загрузки файлов скомпанован аккуратнее. Цифры прогресса загрузки не перекрывают имя файла
		-Добавлена опция G-фильтра G28->+M412S1 (по-умолчанию включено. Датчик филамента включется автоматически после парковки во время печати)
		-Опция Auto M412S1 будет удалена. Умолчания ее настроки будет применяться к G28->+M412S1
