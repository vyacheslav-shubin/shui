...
2022-02-01 (test only) ВНИМАНИЕ! Для COREXY необходимо переключить кинематику Конфигурация/Кинематика
...
2022-02-16 (test only) ТРЕБУЕТСЯ ОБНОВЛЕНИЕ RESDUMP.BIN
	-Починен QR код
...
2022-03-08 (test only)
	...
	-Статус сообщения по смене слоя: Layer 5/0 Z:0.90
