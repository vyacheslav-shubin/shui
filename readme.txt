...
2022-04-05 (test only) (+обновление для EP32)
	...
	Не рекомендуется ее устанавливать, не понимая сути выполненных изменений до окончания тестирования
	или до подтвеждения работоспособности от более опытных участников.
