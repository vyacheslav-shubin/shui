...
2022-10-10 (test only) Требуется обновление RESDUMP.BIN
	...
	подключенным сенсором филамента, двумя моторами/датчиками на оси Z, нестандартным подлючением фидера экструдера.
	...
	-Предыдущая версия в архите: firmware-22-09-16.zip
