...
2022-10-10 (test only) Требуется обновление RESDUMP.BIN
...
2022-10-17 (test only) обновился RESDUMP.BIN
	-Настройка портов:
		-Нагреватели сопла 
...
2022-11-01 (test only) обновился RESDUMP.BIN
...
2022-11-15 (test only) обновлен RESDUMP.BIN
...
2022-11-22 (test only) обновлен RESDUMP.BIN
...
2022-12-06 (test only) обновлен RESDUMP.BIN
...
2023-01-13 (test only)
	-M209. Авторетракт (ретракты слайсера могут быть переопределены аппаратными ретрактами)
		-M209 I - min, A - max
