...
2021-10-12 (test-only) Обновить RESDUMP.BIN
...
2021-10-23 (test-only) !!! RESDUMP.BIN обновлен
	-Марлин 2021-10-21
	-Перехват комментариев с метаданными печати
	-Счетчик словев
	-Пауза по смене слоя при превыщении значения Z
	-Z offset
	M29 S0, S3, S4, S5
	-backup mbl z-offset
	...
	-Обновлен виджет температур. 
		Долгое нежатие на пресеты вызывает виджет конфигурирования температур
