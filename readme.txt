...
2023-04-29 (test only) обновлен RESDUMP.BIN
...
2023-05-20 (test only) обновлен RESDUMP.BIN
		...
		-Исправлена ошибка отображения выбора типа датчика филаменте для вторго экстружера
