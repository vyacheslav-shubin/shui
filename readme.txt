...
2023-09-24 (test only) ❗️Требуется обновление RESDUMP.BIN
	-📍Input shaping
	-📍Оторбражение кривизны стола градиентом красный-белый-синий

2023-09-26 (test only) ❗️Требуется обновление RESDUMP.BIN
	-📍Обход точек замера сетки кривизны стола выполняется со скростью равной скорости парковки (общие настройки)
	...
	Значенрие по-умолчанию 10 мм, для bltouch достаточно 5 мм. ❗️Скорректируйте эту настройку, если ранее установили меньшие
	 значения.
