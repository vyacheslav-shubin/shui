...
2021-10-08 (dev)
	...
	-Виджет управления филаментом отображение дельты
	-Виджет перемещения. Отображение дельты филамента
	-Обмер стола. Можно задать до 5 обмеров одной точки. В сетку записывается усредненный результат
