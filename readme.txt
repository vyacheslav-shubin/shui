...
2021-08-13 (dev)
	...
	(!!!!) Обновление затрагивает критические программные блоки. Не стоит его устанавливать, если нет полного понимания проведенных изменений и методов их тестирования. 
	Поэтому пока раздел dev (для разработчиков и продвинутых тестеров). Настроки не сохраняются в backup.
