...
2021-11-26 (dev)
	-поддержка плат Robin Nano 1.3 на базе STM32F407
	-Для плат 1.3 в нерабочем состоянии инструменты "Перемещение", "Управление филаментом", модуль WiFi, остальное, предположительно, должно работать
	-Для 1.1, 1.2 все должно работать без изменений

2021-11-27 (dev)
	-Парковка по сенсору стола
	
2021-11-29 (dev) ВНИМАНИЕ @snippets.gcode обновлен! Если ранее использовались сниппеты ПРИМЕНЕНИЕ @snippets.gcode после прошивки ОБЯЗАТЕЛЬНО!
	-Реанимированы виджеты "Перемещение", "Управление филаментом" для F407
