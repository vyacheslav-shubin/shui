...
2022-09-17 (test only)
	-Восстановление печати просле выключения питания. Этап 2, проверка достаточности.
		по сигналу на PA2 или по переходу на паузу в каталоге создается файл RECOVERY.GCO (ранее файл надывался с ошибкой RECOVER.GCO, не путать)
		Запуск этого файла приведет к восстановлению ранее преравнной печати.
Эксперимент:
	Запустить печать, через некоторое время нажать на паузу, вылючить питание принтера
