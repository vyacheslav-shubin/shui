...
2022-09-15 (test only)
	...
	-открытие файлов для печать теперь происходит чуть дольше (цена за QOI). 
		Вернее это время осталось прежним, но его более заметно, так как раньше оно распределялось между переходами в виджетах. 
		Поддержка QOI требует больших ресурсов и сохранение их при перехах между виджетами не рационально.
		https://www.aconvert.com/image/png-to-qoi/ - тут можно перобазовать PNG в QOI
