...
2024-07-16 (test_only) Требуется обновление WIFI модуля ESP32
	...
	-📍Если отправить файла в TG канал связаррый с принтером с подписью "print" файл будет отправлени на печать (исполнен), "save" - сохранет,
		 "link" на флеш карте будет создан файл-ссылка позволяющий в дальнейшем загрузить файла (не полностью доступно).
