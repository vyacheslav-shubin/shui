...
//#define PID_EDIT_MENU         // Add PID editing to the "Advanced Settings" menu. (~700 bytes of PROGMEM)
  ...
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  41.05,  41.05 }
    #define DEFAULT_Ki_LIST {   4.83,   4.83 }
    #define DEFAULT_Kd_LIST { 87.22, 87.22 }
  #else
    #define DEFAULT_Kp  41.05
    #define DEFAULT_Ki   4.83
    #define DEFAULT_Kd 87.22
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 98.98 }
...
#define INVERT_X_DIR is_motor_axis_inverted(X)
#define INVERT_Y_DIR is_motor_axis_inverted(Y)
#define INVERT_Z_DIR is_motor_axis_inverted(Z)
...
//((float)SHUI::config.machine_size.x)
#define Y_BED_SIZE 210
//((float)SHUI::config.machine_size.y)
